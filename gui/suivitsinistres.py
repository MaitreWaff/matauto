...
import ui_suivitsinistres

class SuivitSinistres(QtGui.QMainWindow, ui_suivitsinistres.Ui_SuivitSinistre):
    ...
    def closeEvent(self, event):
        print "Fermeture Suivit Sinistres!"
        event.accept()
